...
@section('title','Jobick : Job Admin Dashboard Bootstrap 5 Template + FrontEnd')
@section('styles')
                    ...
                    <ul class="bnr-blocks">
                        ...
                        <li>
                            <div class="bnr-block-pics wow fadeInUp anm" data-wow-delay="1.6s" data-speed-x="-3" data-speed-scale="-1">
                                ...
                                <div class="twm-pics">
                                    <span><img src="{{asset('frontend/assets/images/banner/banner-block-pics/pic1.jpg') }}" alt="image"></span>
                                    <span><img src="{{asset('frontend/assets/images/banner/banner-block-pics/pic2.jpg') }}" alt="image"></span>
                                    <span><img src="{{asset('frontend/assets/images/banner/banner-block-pics/pic3.jpg') }}" alt="image"></span>
                                    <span><img src="{{asset('frontend/assets/images/banner/banner-block-pics/pic4.jpg') }}" alt="image"></span>
                                </div>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 m-b30 ">
                <div class="dz-media style-1">
                    <div class="row">
                        <div class="col-6">
                            <img src="{{asset('frontend/assets/images/about/pic1.jpg') }}" alt="image" class="wow bounceInLeft" data-wow-delay="0.6s">
                        </div>
                        <div class="col-6">
                            <img src="{{asset('frontend/assets/images/about/pic2.jpg') }}" alt="image" class="wow bounceInLeft" data-wow-delay="0.4s">
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6">
                <div class="job-bx style-1 wow fadeInUp" data-wow-delay="1.0s">
                    <div class="d-flex m-b25 justify-content-between">
                        <span class="media">
                            <img src="{{asset('frontend/assets/images/company-logo/pic1.png')}}" alt="image">
                        </span>
                        <ul>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="job-bx style-1 wow fadeInUp" data-wow-delay="1.2s">
                    <div class="d-flex m-b25 justify-content-between">
                        <span class="media">
                            <img src="{{asset('frontend/assets/images/company-logo/pic2.png') }}" alt="image">
                        </span>
                        <ul>
                            <li><a class="job-day" href="javascript:void(0);">1 Day Ago</a></li>
                            <li><a class="job-time" href="javascript:void(0);">Full Time</a></li>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="job-bx style-1 wow fadeInUp" data-wow-delay="1.6s">
                    <div class="d-flex m-b25 justify-content-between">
                        <span class="media">
                            <img src="{{asset('frontend/assets/images/company-logo/pic3.png') }}" alt="image">
                        </span>
                        <ul>
                            <li><a class="job-day" href="javascript:void(0);">1 Day Ago</a></li>
                            <li><a class="job-time" href="javascript:void(0);">Full Time</a></li>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="job-bx style-1 wow fadeInUp" data-wow-delay="1.0s">
                    <div class="d-flex m-b25 justify-content-between">
                        <span class="media">
                            <img src="{{asset('frontend/assets/images/company-logo/pic4.png')}}" alt="image">
                        </span>
                        <ul>
                            <li><a class="job-day" href="javascript:void(0);">1 Day Ago</a></li>
                            <li><a class="job-time" href="javascript:void(0);">Full Time</a></li>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="job-bx style-1 wow fadeInUp" data-wow-delay="1.2s">
                    <div class="d-flex m-b25 justify-content-between">
                        <span class="media">
                            <img src="{{asset('frontend/assets/images/company-logo/pic5.png') }}" alt="image">
                        </span>
                        <ul>
                            <li><a class="job-day" href="javascript:void(0);">1 Day Ago</a></li>
                            <li><a class="job-time" href="javascript:void(0);">Full Time</a></li>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="job-bx style-1 wow fadeInUp" data-wow-delay="1.6s">
                    <div class="d-flex m-b25 justify-content-between">
                        <span class="media">
                            <img src="{{asset('frontend/assets/images/company-logo/pic6.png')}}" alt="image">
                        </span>
                        <ul>
                            <li><a class="job-day" href="javascript:void(0);">1 Day Ago</a></li>
                            <li><a class="job-time" href="javascript:void(0);">Full Time</a></li>
                    ...
                    <div class="dz-card blog-grid style-2 bg-light wow fadeInUp" data-wow-delay="1.0s">
                        ...
                        <div class="dz-info">
                            <div class="bottom-contact">
                                <div class="dz-media">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/images/blog/small/pic1.jpg')}}" alt=""></a>
                                </div>
                                <div>
                ...
                <div class="swiper-slide">
                    <div class="dz-card blog-grid style-2 bg-light wow fadeInUp" data-wow-delay="1.2s">
                        ...
                        <div class="dz-info">
                            <div class="bottom-contact">
                                <div class="dz-media">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/images/blog/small/pic2.jpg') }}" alt=""></a>
                                </div>
                                <div>
                ...
                <div class="swiper-slide">
                    <div class="dz-card blog-grid style-2 bg-light wow fadeInUp" data-wow-delay="1.4s">
                        ...
                        <div class="dz-info">
                            <div class="bottom-contact">
                                <div class="dz-media">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/images/blog/small/pic3.jpg')}}" alt=""></a>
                                </div>
                                <div>
