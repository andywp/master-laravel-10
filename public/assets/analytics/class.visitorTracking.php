   ...
   *
    ...
    */
	...
	/* private function geoCheckIP($ip)
	{
		...
		include("geoip.php");
		//$value = json_decode(file_get_contents('http://citraweb.co.id/sasanalytic/geoip.php?ip='.$ip));
	...
	private function geoCheckIP($ip)
	{
		...
		$ip_info_new['country'] = @$value->geoplugin_countryCode.' - '.@$value->geoplugin_countryName;
		$ip_info_new['domain']	= 'not found';
		$ip_info_new['state']	= @$value->geoplugin_countryName;
		$ip_info_new['town']	= @$value->geoplugin_city;
